...
import com.siddhant.BlogApplication.entities.*;
import com.siddhant.BlogApplication.repositories.PostRepository;
import com.siddhant.BlogApplication.services.CategoryService;
import com.siddhant.BlogApplication.services.PostService;
...
public class PostServiceImpl implements PostService {
    ...
    public List<Post> getAllPosts(UUID categoryId, UUID tagId) {
      ...
      Category category = categoryService.getCategoryById(categoryId);
        ...
        if (tagId != null) {
            Tag tag = tagService.getTagById(tagId);
            return postRepository.findAllByStatusAndTagsContaining(PostStatus.PUBLISHED,
                    tag);
        }
